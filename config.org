...
#+author: Zhicheng Lee, Simon Wang
...
;; 个人信息配置
(setq user-full-name "Qingwu Wang"
      user-mail-address "wangqwa@chanjet.com"
      user-blog-url "https://www.m0110.com"
      lsp-latex-texlab-executable "~/local/bin/texlab"
...
(after! mu4e
  ...
  ;;  )
  (set-email-account!
   "qq" '((user-mail-address    . "15281427@qq.com")
          (user-full-name       . "Wang Qingwu")
          (smtpmail-smtp-user   . "15281427@qq.com")
  ...
  (set-email-account!
   "chanjet" '((user-mail-address    . "wangqwa@chanjet.com")
                (user-full-name       . "Wang Qingwu")
                (smtpmail-smtp-user   . "wangqwa@chanjet.com")
                (smtpmail-default-smtp-server   . "smtp.qiye.aliyun.com")
                (smtpmail-smtp-server           . "smtp.qiye.aliyun.com")
                (smtpmail-smtp-service          . 465)
                ;; Optional
                (mu4e-sent-folder     . "/chanjet.com/Sent")
                (mu4e-drafts-folder   . "/chanjet.com/Drafts")
                (mu4e-trash-folder    . "/chanjet.com/Trash")
                (mu4e-refile-folder   . "/chanjet.com/All")
                (mu4e-get-mail-command    . "mbsync chanjet")
                (mu4e-compose-signature   . "-----")
                )
   t)
  )
...
(after! mu4e
  (setq! mu4e-maildir (expand-file-name "~/.mail") ; the rest of the mu4e folders are RELATIVE to this one
         ...
         message-signature-file "~/.emacs.d/.authinfo.gpg"
...
(set-email-account! "wangqwa@chanjet.com"
                    '((user-mail-address      . "wangqwa@chanjet.com")
                      (user-full-name         . "Qingwu Wang")
                      (smtpmail-smtp-server   . "smtp.qiye.aliyun.com")
...
(use-package! mu4e-alert
  ...
  (setq mu4e-alert-interesting-mail-query
    (concat
     "flag:unread maildir:/chanjet.com/Inbox "
     "OR "
