...
Keybindings reference: [[https://github.com/hlissner/doom-emacs/blob/develop/modules/config/default/%2Bevil-bindings.el][evil-bindings.el]]
...
*** 定位语句(~backward|forward-sentence-begin~)
...
*gs -> +*, ~next-line-first-non-blank~

*gs -> -*, ~previous-line-first-non-blank~
